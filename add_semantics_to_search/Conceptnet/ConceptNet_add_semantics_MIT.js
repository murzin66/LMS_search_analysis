...
const fs = require('fs').promises; // Используем promises для работы с промисами

// Функция для получения семантически близких терминов
...
async function runMITTests() {
    ...
    await fs.writeFile('results.txt', output); // Исправлено на async writeFile
